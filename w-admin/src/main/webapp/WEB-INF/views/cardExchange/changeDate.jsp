...
<body>
	<div>
		<jdf:form bean="entity" scope="request">
			...
			<form name="form1" method="post" action="${dynamicDomain}/CardExchange/viewPhysicalDetail/${cardNo}" id="appointment" class="form-horizontal" >
				<input type="hidden" name="objectId">
				<div class="box-body">
					<div class="row">
		             <div class="col-sm-4 col-md-4">
		              <div class="form-group">
		                <label class="col-sm-4 control-label">您已选择：</label>
		                <div class="col-sm-8 upView">${shopName}</div>
		              </div>
		            </div>
		            <div class="col-sm-4 col-md-4">
		              <div class="form-group">
		                <label class="col-sm-4 control-label">上次预约时间:</label>
				...
				<%-- <ul>
        			<li class="con-size1"><label>您已选择:</label>您已选择：${shopName }</li>
        				<li class="con-size2"><label>上次预约时间:</label><span class="con-color"><fmt:formatDate value="${pSubscribe.physicalDate }" pattern=" yyyy-MM-dd "/></span>
        			</li>
    			</ul> --%>
