...
<body>
	...
	<div class="box-body">
			...
			<div align="center">
				<span style="color: red;font-size:20px" ><stong>体检取消失败!</stong></span><br>
				<span  ><stong>请重新取消！</stong></span><br>
			</div>
    ...
    <div class="box-footer">
						<div class="row">
							<div class="editPageButton">
								<button type="button" class="btn btn-primary progressBtn" id="confirmTime" onclick="viewPhysicalDetail();">重新取消</button>
