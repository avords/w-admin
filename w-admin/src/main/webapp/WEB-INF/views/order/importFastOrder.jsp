...
<body>
	<div>
		<div class="callout callout-info">
			...
			<h4 class="modal-title">导入已发货单号</h4>
		</div>
			<jdf:form bean="request" scope="request">
				<form method="post" action="${dynamicDomain}/fastOrder/uploadFastOrder?ajax=1" class="form-horizontal import" id="isform" name="isform" enctype="multipart/form-data">
					...
					<div class="row">
						<div class="col-sm-6 col-md-6">
							<div class="form-group">
								<label  class="col-sm-4 control-label"> 已发货单号导入：</label><u><a href="${dynamicDomain}/fastOrder/exportTemplate" target="_blank">模板下载</a></u><br><br>
								<div class="col-sm-6">
