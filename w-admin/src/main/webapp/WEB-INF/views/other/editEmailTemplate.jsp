...
<title><jdf:message code="邮件通知模版" /></title>
...
<body>
    <div>
		    <jdf:form bean="entity" scope="request">
		     <form method="post" action="${dynamicDomain}/other/emailTemplate/saveEmail" class="form-horizontal" id="MessageTemplate" enctype="multipart/form-data">
			        <div class="callout callout-info">
			            <div class="message-right">${message }</div>
			            <h4 class="modal-title"><jdf:message code="邮件通知模版" />
			            <c:choose>
				...
				<div class="box-body">
					...
					<div class="row">
						<div class="col-sm-12 col-md-12">
							<div class="form-group">
								<label for="messageTitle" class="col-sm-2 control-label">邮件标题</label>
								<div class="col-sm-6">
									<input type="text" class="search-form-control"
										name="messageTitle"  maxlength="50">
								</div>
							</div>
						</div>
					</div>
					...
					<div class="row">
	                    <div class="col-sm-12 col-md-12">
	                        <div class="form-group">
	                            ...
	                            <div class="col-sm-8" >
	                                <textarea name="messageContent" id="txt"></textarea> 
	...
	$(function(){
		$("#sub").click(function(){
			...
			//var regx=/^(((?![0-9]+$)(?![a-zA-Z]+$)[0-9A-Za-z])|([0-9_])|([a-zA-Z]))*$/;
			var regx=/^\w+$/i;
		    ...
		    var introducevalue=CKEDITOR.instances["txt"].getData();;
		    introducevalue = introducevalue.trim();
		    if(introducevalue==""){ 
			...
			if(str == ""){
				...
				var url = "${dynamicDomain}/other/emailTemplate/isUniqueTemplate?objectId=${entity.objectId}&deleted=0";
				$.ajax({
					type: "post",
					dataType: "json",
					data : data,
				...
				$("#MessageTemplate").attr("action","${dynamicDomain}/other/emailTemplate/saveEmail?str=editEmail");
				$("#MessageTemplate").submit();
			}
		});
	});
...
<script type="text/javascript">
function comeBack(){
	window.location.href = '${dynamicDomain}/other/emailTemplate/queryEmailList';
}
</script>
</body>
</html>