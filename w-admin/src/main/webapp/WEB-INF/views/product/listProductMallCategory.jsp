...
<body>
	<div>
		<div class="callout callout-info">
			<h4 class="modal-title">
				...
				<h4 class="modal-title">福利商城一级分类</h4>
			</h4>
		</div>
		<jdf:form bean="request" scope="request">
			<form action="${dynamicDomain}/productMallCategory/page" method="post"
				class="form-horizontal">
				<div class="box-body">
					<div class="row">	
						<div class="col-sm-4 col-md-4">
							<div class="form-group">
								<label class="col-sm-6 control-label">一级分类编号：</label>
								<div class="col-sm-6">
									<input type="text" class="search-form-control"
										name="search_LIKES_firstId">
								</div>
							</div>
						</div>							
						<div class="col-sm-4 col-md-4">
                        ...
                        <div class="col-sm-4 col-md-4">
							<div class="form-group">
								...
								<div class="col-sm-8">
									<jdf:checkBox dictionaryId="1114" name="search_ICI_platform"/>
								</div>
							</div>
                        </div>						
					</div>
                ...
                <div class="box-footer">
                    <a href="${dynamicDomain}/productMallCategory/create?ajax=1" class="colorbox-mini-iframe pull-left btn btn-primary">
    ...
    <div>
        <jdf:table items="items" var="currentRowObject" retrieveRowsCallback="limit" filterRowsCallback="limit" sortRowsCallback="limit" action="page">
            <jdf:export view="csv" fileName="福利商城一级分类.csv" tooltip="导出CSV" imageName="csv" />
            <jdf:export view="xls" fileName="福利商城一级分类.xls" tooltip="导出EXCEL" imageName="xls" />
            <jdf:row>
                ...
                <jdf:column alias="操作" title="common.lable.operate" sortable="false" viewsAllowed="html" style="width: 8%">
                    <a href="${dynamicDomain}/productMallCategory/edit/${currentRowObject.objectId}?ajax=1" class="btn btn-primary btn-mini colorbox-mini-iframe"> 
                    	<i class="glyphicon glyphicon-pencil"></i> 
                    </a>
                    <a  href="javascript:toDeleteUrl('${dynamicDomain}/productMallCategory/delete/${currentRowObject.objectId}?action=../page')"  class="btn btn-danger btn-mini"> 
                    	<i class="glyphicon glyphicon-trash"></i>
                    </a>
                </jdf:column>
				<jdf:column property="rowcount" sortable="false" cell="rowCount" title="序号" style="width:4%;text-align:center"/>
                <jdf:column property="firstId" title="一级分类编号" headerStyle="width:20%;" />
                <jdf:column property="name" title="一级分类名称" headerStyle="width:20%;" />
                <jdf:column property="sortNo" title="排序" headerStyle="width:8%;" >
                	<input type="text" value="${currentRowObject.sortNo }" name="sortNos" id="sortNos${currentRowObject.objectId}" class="order-form-control">
                </jdf:column>
                <jdf:column property="1" title="二级分类" headerStyle="width:8%;" viewsDenied="html">  
                	${currentRowObject.childrenCount }
               	</jdf:column>         
                <jdf:column property="childrenCount" title="二级分类" headerStyle="width:8%;" viewsAllowed="html">  
                	<a href="${dynamicDomain}/productMallCategory/secondpage?search_EQL_firstId=${currentRowObject.firstId}" class="active">${currentRowObject.childrenCount }</a>
               	</jdf:column>          		
                <jdf:column property="platform" title="所属平台" headerStyle="width:8%;"> 
                    <jdf:columnValue dictionaryId="1114" value="${currentRowObject.platform}" />
                </jdf:column>                
                <jdf:column property="status" title="状态" headerStyle="width:8%;">
