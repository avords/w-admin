...
<body>
    <div>
        ...
        <jdf:form bean="entity" scope="request">
                <form method="post" action="${dynamicDomain}/productMallCategory/save?ajax=1" class="form-horizontal" id="ProductMallCategory">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="col-sm-12 col-md-12">
                                <div class="form-group">
									<label for="firstId" class="col-sm-5 control-label">一级分类编号</label>                              
									<span class="lable-span">${entity.firstId}</span>                               
                                </div>
                            </div>                           
                        </div>
                        <div class="row">
							<div class="col-sm-12 col-md-12">
								<div class="form-group">
									<label for="name" class="col-sm-5 control-label">一级分类名称</label>
									<div class="col-sm-7">
						...
						<div class="row">
							<div class="col-sm-12 col-md-12 menuContent">
								<div class="form-group">
									<label for="platform" class="col-sm-5 control-label">所属平台</label>
									<div class="col-sm-7">
										<c:if test="${not empty entity.objectId}">
										<input type="hidden" name="platform">
										<span class="lable-span"><jdf:dictionaryName dictionaryId="1114" value="${entity.platform }"/></span>
										</c:if>
										<c:if test="${empty entity.objectId}">
										<jdf:checkBox dictionaryId="1114" name="platform"/>
										</c:if>
									</div>
								</div>
							</div>
                    ...
                    <div class="box-footer">
                        <div class="row">
							<div class="editPageButton">
								<button type="submit" class="btn btn-primary" onclick="closeBox();"> 保存
								</button>
							</div> 
                        </div>
                        </div>
