...
<body>
    <div>
        ...
        <jdf:form bean="entity" scope="request">
                <form method="post" action="${dynamicDomain}/productCategory/save?ajax=1" class="form-horizontal" id="ProductCategory">
