...
<body>
	<div>
		<div class="callout callout-info">
			<h4 class="modal-title">
				...
				<h4 class="modal-title">商品运营二级分类</h4>
			</h4>
		</div>
		<jdf:form bean="request" scope="request">
			<form action="${dynamicDomain}/productCategory/secondpage" method="post" class="form-horizontal">
				<div class="box-body">
					<div class="row">				
                        <div class="col-sm-4 col-md-4">
                            <div class="form-group">
								<label for="name" class="col-sm-6 control-label">所属一级分类名称：</label>                              
								<span class="lable-span">${firstProductCategory.name}</span>                                
                            </div>
                        </div>
                        <div class="pull-right">
                        	<a href="${dynamicDomain }/productCategory/page" class="btn btn-primary">返回</a>
                        </div>                         
					</div>	
					<div class="row">
						<div class="col-sm-4 col-md-4">
                ...
                <div class="box-footer">
                	<c:if test="${firstProductCategory.status==1 }">
                    <a href="${dynamicDomain }/productCategory/createSecondCategory?ajax=1" class="colorbox-mini pull-left btn btn-primary">
    ...
    <div>
        <jdf:table items="items" var="currentRowObject" retrieveRowsCallback="limit" filterRowsCallback="limit" sortRowsCallback="limit" action="secondpage">
            <jdf:export view="csv" fileName="商品运营二级分类.csv" tooltip="导出CSV" imageName="csv" />
            <jdf:export view="xls" fileName="商品运营二级分类.xls" tooltip="导出EXCEL" imageName="xls" />
            <jdf:row>
                ...
                <jdf:column alias="操作" title="common.lable.operate" sortable="false" viewsAllowed="html" style="width: 4%">
                    <a href="${dynamicDomain}/productCategory/editSecondCategory/${currentRowObject.secondId}?ajax=1&firstId=${param.search_EQS_firstId}" class="btn btn-primary btn-mini colorbox-mini"> 
                    	<i class="glyphicon glyphicon-pencil"></i>
                    </a>
                </jdf:column>
				<jdf:column property="rowcount" sortable="false" cell="rowCount" title="序号" style="width:4%;text-align:center"/>
                <jdf:column property="secondId" title="商品运营二级分类编号" headerStyle="width:20%;" />
                ...
                <jdf:column property="1" title="三级分类数量" headerStyle="width:10%;" viewsDenied="html">  
                	${currentRowObject.childrenCount }
               	</jdf:column>                  
                <jdf:column property="childrenCount" title="三级分类数量" headerStyle="width:10%;" viewsAllowed="html">  
                	<a href="${dynamicDomain}/productCategory/thirdpage?search_EQS_secondId=${currentRowObject.secondId}" class="active">${currentRowObject.childrenCount }</a>
               	</jdf:column>          
