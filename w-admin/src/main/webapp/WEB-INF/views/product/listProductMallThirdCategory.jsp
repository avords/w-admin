...
<body>
	<div>
		<div class="callout callout-info">
			<h4 class="modal-title">
				...
				<h4 class="modal-title">福利商城三级分类</h4>
			</h4>
		</div>
		<jdf:form bean="request" scope="request">
			<form action="${dynamicDomain}/productMallCategory/thirdpage" method="post"
				class="form-horizontal">
				<div class="box-body">
					<div class="row">
                        <div class="col-sm-4 col-md-4">
                            <div class="form-group">
								<label class="col-sm-6 control-label">所属二级分类名称：</label>
								<div class="col-sm-6">                           
									<span class="lable-span">${secondProductMallCategory.name}</span>
								</div>                               
                            </div>                            
                        </div> 
                        <div class="col-sm-4 col-md-4">
                        ...
                        <div class="col-sm-4 col-md-4">
	                        <div class="pull-right">
	                        	<a href="${dynamicDomain}/productMallCategory/secondpage" class="btn btn-primary">返回</a>
	                        </div>
                        </div>                     						
					</div>				
					<div class="row">
                ...
                <div class="box-footer">
                	<c:if test="${secondProductMallCategory.status==1 }">
                    <a href="${dynamicDomain}/productMallCategory/createMallThirdCategory" class="pull-left btn btn-primary">
    ...
    <div>
        <jdf:table items="items" var="currentRowObject" retrieveRowsCallback="limit" filterRowsCallback="limit" sortRowsCallback="limit" action="thirdpage">
            <jdf:export view="csv" fileName="福利商城三级分类.csv" tooltip="导出CSV" imageName="csv" />
            <jdf:export view="xls" fileName="福利商城三级分类.xls" tooltip="导出EXCEL" imageName="xls" />
            <jdf:row>
                ...
                <jdf:column alias="操作" title="common.lable.operate" sortable="false" viewsAllowed="html" style="width: 8%">
                    <a href="${dynamicDomain}/productMallCategory/editMallThirdCategory/${currentRowObject.objectId}?" class="btn btn-primary btn-mini">  
                    	<i class="glyphicon glyphicon-pencil"></i>
                    </a>
                    <a  href="javascript:toDeleteUrl('${dynamicDomain}/productMallCategory/delete/${currentRowObject.objectId}?action=../thirdpage')"  class="btn btn-danger btn-mini"> 
                    	<i class="glyphicon glyphicon-trash"></i>
                    </a>
                </jdf:column>
				<jdf:column property="rowcount" sortable="false" cell="rowCount" title="序号" style="width:4%;text-align:center"/>
                <jdf:column property="thirdId" title="三级分类编号" headerStyle="width:20%;" />
