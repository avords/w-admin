	                                             ...
	                                             <c:forEach items="${selectedProductType }" var="selectId" varStatus="status">
                                                  ...
                                                  <c:choose>
                                                       <c:when test="${isHaveType==1 }">
                                                           ...
                                                           <input type="radio" name="productTypes" checked="checked" class="productTypes" value="${item.value }"><span>${item.name }</span>&nbsp;
                                                       </c:when>
                                                       <c:otherwise>
                                                           <input type="radio" name="productTypes" class="productTypes" value="${item.value }"><span>${item.name }</span>&nbsp;
                                                       </c:otherwise>
                                                    </c:choose>
	                                        </c:forEach>
