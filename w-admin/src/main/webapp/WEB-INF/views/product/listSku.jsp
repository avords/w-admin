...
<body>
    <div>
        ...
        <jdf:form bean="request" scope="request">
            <form action="${dynamicDomain}/sku/page" method="post"
    ...
    <div>
        <jdf:table items="items" var="currentRowObject" retrieveRowsCallback="limit" filterRowsCallback="limit" sortRowsCallback="limit" action="page?message=">
            ...
            <jdf:row>
                ...
                <jdf:column alias="操作" title="操作" sortable="false" viewsAllowed="html"
                    ...
                    <c:choose>
                            <c:when test="${currentRowObject.product.releaseType==1}">
                               <c:if test="${currentRowObject.checkStatus!=2&&currentRowObject.checkStatus!=5}">
                                    <a href="${dynamicDomain}/product/edit/${currentRowObject.productId}"
                            ...
                            <c:otherwise>
                                <c:if test="${currentRowObject.checkStatus==4||currentRowObject.checkStatus==6}">
                                    <a href="${dynamicDomain}/product/edit/${currentRowObject.productId}"
			                            class="btn btn-primary btn-mini"> <i
			                            class="glyphicon glyphicon-pencil"></i>
			                        </a>
