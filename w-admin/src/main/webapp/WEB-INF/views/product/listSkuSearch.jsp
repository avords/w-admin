...
<title><jdf:message code="商品信息查询" /></title>
</head>
<body>
    <div>
        <div class="callout callout-info">
            <h4 class="modal-title">
                ...
                <jdf:message code="商品信息查询" />
            </h4>
        </div>
        <jdf:form bean="request" scope="request">
            <form action="${dynamicDomain}/sku/search" method="post"
                ...
                <div class="box-footer">
                    <a href="javascript:void(0);" class="btn btn-primary pull-left progressBtn" onclick="downProduct();">下架
                    </a>
    ...
    <div>
        <jdf:table items="items" var="currentRowObject" retrieveRowsCallback="limit" filterRowsCallback="limit" sortRowsCallback="limit" action="search">
            <jdf:export view="csv" fileName="商品查询.csv" tooltip="导出CSV"
                imageName="csv" />
            <jdf:export view="xls" fileName="商品查询.xls" tooltip="导出EXCEL"
                imageName="xls" />
            <jdf:row>
