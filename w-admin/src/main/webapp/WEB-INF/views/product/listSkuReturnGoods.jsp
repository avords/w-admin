...
<title><jdf:message code="商品退货设置" /></title>
</head>
<body>
    <div>
        <div class="callout callout-info">
            <h4 class="modal-title">
                ...
                <jdf:message code="商品退货设置" />
            </h4>
        </div>
        <jdf:form bean="request" scope="request">
            <form action="${dynamicDomain}/sku/returnGoods" method="post"
                ...
                <div class="box-footer">
                    <a href="javascript:void(0);" class="btn btn-primary pull-left progressBtn" onclick="prohibitReturnGoods();">禁止退货
                    </a>
                    <a href="javascript:void(0);" class="btn btn-primary pull-left progressBtn" onclick="allowReturnGoods();">允许退货
                    </a>
    ...
    <div>
        <jdf:table items="items" var="currentRowObject" retrieveRowsCallback="limit" filterRowsCallback="limit" sortRowsCallback="limit" action="returnGoods">
            <jdf:export view="csv" fileName="商品退货设置.csv" tooltip="导出CSV"
                imageName="csv" />
            <jdf:export view="xls" fileName="商品退货设置.xls" tooltip="导出EXCEL"
                imageName="xls" />
            <jdf:row>
                ...
                <jdf:column property="rowcount" sortable="false" cell="rowCount" title="序号" style="width:3%;text-align:center" headerStyle="width:3%;"/>
                <jdf:column property="returnGoods" title="是否可退货" headerStyle="width:5%;">
                  <jdf:columnValue dictionaryId="109" value="${currentRowObject.returnGoods}" />
                </jdf:column>
    ...
    function prohibitReturnGoods(){
       var ids = getIds();
       var url = "${dynamicDomain}/sku/setReturnGoods?skuIds="+ids+"&value=0";
       window.location.href = url;
    }
    function allowReturnGoods(){
        var ids = getIds();
        var url = "${dynamicDomain}/sku/setReturnGoods?skuIds="+ids+"&value=1";
        window.location.href = url;
    }
    $("#checkall").click( 
            function(){ 
