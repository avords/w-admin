...
<%--         <div id="preview"><img id="generated" src="${dynamicDomain}${filePath}"  /></div>  --%>
     ...
     $(function() {
          ...
          $("#crop").click(function(){//裁剪提交
               cropzoom.send('${dynamicDomain}/productScreenshot/saveSpecCrop?productId=${param.productId}&attrValId=${param.attrValId}', 'POST', {'srcFilePath':'${filePath}'}, function(imgRet) {
                   var filePath = '${dynamicDomain}'+imgRet.filePath;
                   $('#attValImg${param.attrValId}',window.parent.document).attr('src',filePath);
