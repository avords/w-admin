...
<title>福利商城二级分类</title>
</head>
<body>
    <div>
        <div class="callout callout-info">
            <div class="message-right">${message }</div>
             <h4 class="modal-title">福利商城二级分类
				<c:choose>
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-12">
                                <div class="form-group">
									<label for="secondId" class="col-sm-5 control-label">二级分类编号</label>                              
									<span class="lable-span">${entity.secondId}</span>                               
                                </div>
                            </div>                           
                        </div>
                        <div class="row">
							<div class="col-sm-12 col-md-12">
								<div class="form-group">
									<label for="name" class="col-sm-5 control-label">二级分类名称</label>
									<div class="col-sm-7">
