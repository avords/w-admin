...
<body>
	<div>
		<div class="callout callout-info">
			<h4 class="modal-title">
				...
				<h4 class="modal-title">商品运营一级分类</h4>
			</h4>
		</div>
		<jdf:form bean="request" scope="request">
			<form action="${dynamicDomain}/productCategory/page" method="post" class="form-horizontal">
                ...
                <div class="box-footer">
                    <a href="${dynamicDomain}/productCategory/create?ajax=1" class="colorbox-mini-iframe pull-left btn btn-primary">
    ...
    <div>
        <jdf:table items="items" var="currentRowObject" retrieveRowsCallback="limit" filterRowsCallback="limit" sortRowsCallback="limit" action="page">
            <jdf:export view="csv" fileName="商品运营一级分类.csv" tooltip="导出CSV" imageName="csv" />
            <jdf:export view="xls" fileName="商品运营一级分类.xls" tooltip="导出EXCEL" imageName="xls" />
            <jdf:row>
                ...
                <jdf:column alias="操作" title="common.lable.operate" sortable="false" viewsAllowed="html" style="width: 4%">
                    <a href="${dynamicDomain}/productCategory/edit/${currentRowObject.objectId}?ajax=1" class="btn btn-primary btn-mini colorbox-mini-iframe"> 
                    	<i class="glyphicon glyphicon-pencil"></i>
                    </a>
                </jdf:column>
				<jdf:column property="rowcount" sortable="false" cell="rowCount" title="序号" style="width:4%;text-align:center"/>
                <jdf:column property="firstId" title="商品运营一级分类编号" headerStyle="width:20%;" />
                ...
                <jdf:column property="childrenCount" title="二级分类数量" headerStyle="width:10%;" viewsAllowed="html">  
                	<a href="${dynamicDomain}/productCategory/secondpage?search_EQS_firstId=${currentRowObject.firstId}" class="active">${currentRowObject.childrenCount }</a>
               	</jdf:column>          
