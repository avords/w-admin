					                    ...
					                    <tbody>
						                    <tr id="item1">
							                        ...
							                        <td>${secondItemName }</td> 
							                         ...
							                         <td><input type="text" name="supplierPrice" readonly ></td>
							                        <td><input type="text" name="marketPrice" readonly ></td>
			...
			<div class="box-footer">
					<div class="row">
						<div class="editPageButton">
							<!-- <button type="button"  onclick="subPrice()" class="btn btn-primary">返回</button> -->
							<a href="${dynamicDomain}/physicalAudited/auditedPage" class="btn btn-primary">返回</a>
						</div>
					</div>
			</div>
	</div>
