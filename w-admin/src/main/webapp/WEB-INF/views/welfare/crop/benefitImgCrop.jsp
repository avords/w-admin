     ...
     $(function() {
          ...
          $("#crop").click(function(){//裁剪提交
               cropzoom.send('${dynamicDomain}/welfare/picture/saveCrop', 'POST', {'srcFilePath':'${filePath}'}, function(imgRet) {
                   ...
                   $("#showbenefitImg",window.parent.document).attr('src',filePath);
                   $("#benefitImg",window.parent.document).val(imgRet.filePath);
                   //主动关闭colorbox
                   alert('截图成功!可以关闭窗口查看了！');
                   $("#uploadButton1",window.parent.document).colorbox.close();
               });             
          });
