...
<body>
	<div>
		...
		<jdf:form bean="request" scope="request">
			<form action="${dynamicDomain}/cardCreateInfo/cardCreateInfopageToCount" method="post"
				...
				<div class="box-footer">
					<a href="${dynamicDomain}/cardCreateInfo/createCard" class="btn btn-primary pull-left">
	...
	<div>
		<jdf:table items="items" var="currentRowObject"  retrieveRowsCallback="limit" filterRowsCallback="limit"
			sortRowsCallback="limit" action="${dynamicDomain}/cardCreateInfo/cardCreateInfopageToCount">
			...
			<jdf:row>
				<jdf:column alias="common.lable.operate"
					...
					<a
						href="${dynamicDomain}/cardInfo/countCardInUse/${currentRowObject.objectId}"
