...
<body>
	<div>
		...
		<jdf:form bean="request" scope="request">
			<form action="${dynamicDomain}/cardInfo/page/${createInfoId}"  method="post"  id="cardInfo"
				...
				<c:choose>
						<c:when test="${cardStatus eq 0 }">
								<div class="pull-left">
									<button type="button" onclick="exportAllWithNo();" class="btn btn-primary">
										导出
									</button>
	...
	<div>
		<jdf:table items="items" var="currentRowObject"
			...
			sortRowsCallback="limit" action=" ${dynamicDomain}/cardInfo/page/${createInfoId}">
	...
	<script type="text/javascript">
		function exportAllWithNo(){
			var strSchk = getCheckedValuesString(document.getElementsByName("schk")); 
			if(!strSchk){
				strSchk = null;
			}
			location.href = '${dynamicDomain}/cardInfo/exportAll/${createInfoId}?objectIdArray='+strSchk+'&search_EQI_cardStatus=${cardStatus}';
		}
		function exportAll(){
