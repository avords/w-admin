				 ...
				 <c:if test="${not empty entity.content }">
					...
					<div class="row">
						...
						<div class="row">
                            ...
                            <div class="col-sm-6 col-md-6">
                                <div class="form-group">
                                     <label for="priority" class="col-sm-4 control-label">创建时间</label>
                                     <div class="col-sm-8">
                                        <input type="text"  disabled="disabled" style="width:280px;height:33px;" id="createDate" name="createDate" size="14" class="Wdate" onClick="WdatePicker({dateFmt:'yyyy-MM-dd',maxDate:'#F{$dp.$D(\'createDate\')}',readOnly:true})">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-md-6">
                                <div class="form-group">
                                     <label for="priority" class="col-sm-4 control-label">更新时间</label>
                                     <div class="col-sm-8">
                                        <input type="text"  disabled="disabled" style="width:280px;height:33px;" id="updateDate" name="updateDate" size="14" class="Wdate" onClick="WdatePicker({dateFmt:'yyyy-MM-dd',maxDate:'#F{$dp.$D(\'updateDate\')}',readOnly:true})">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <c:if test="${ not empty entity.checkPerson }">
                         <div class="row">
                            ...
                            <div class="col-sm-6 col-md-6">
                                <div class="form-group">
                                     <label for="priority" class="col-sm-4 control-label">审核时间</label>
                                     <div class="col-sm-8">
                                        <input type="text"  disabled="disabled" style="width:280px;height:33px;" id="checkDate" name="checkDate" size="14" class="Wdate" onClick="WdatePicker({dateFmt:'yyyy-MM-dd',maxDate:'#F{$dp.$D(\'checkDate\')}',readOnly:true})">
                                    </div>
                                </div>
                            </div>
                        </div>
...
$(function(){
	...
	<script type="text/javascript">
		...
		function comeBack(){
			window.location.href = '${dynamicDomain}/advert/verify';
		}
	</script>
