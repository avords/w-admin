...
<body>
	<div>
		<div class="callout callout-info">
			...
			<h4 class="modal-title">新闻公告审核</h4>
		</div>
                            ...
                            <div class="col-sm-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <input value="<fmt:formatDate value="${entity.endDate}" pattern="yyyy-MM-dd HH:mm:ss"/>" type="text" style="width:155px;height:33px;" id="endDate" name="endDate" size="14" class="Wdate" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',minDate:'#F{$dp.$D(\'endDate\')}',readOnly:true})" disabled="disabled">
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6 col-md-6">
                        ...
                        <div class="row">
                             <div class="col-sm-6 col-md-6">
                                <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                              <input type="radio" checked="checked" name="releaseNow" value="1" >是&nbsp;&nbsp;&nbsp;&nbsp;
					...
					<div class="box-footer">
						<div class="row">
							<div class="editPageButton">
								...
								<button type="button" class="btn btn-primary progressBtn" onclick="checkPass();" >
									 审核通过
								</button>
                                <button type="button" class="btn btn-primary progressBtn" onclick="checkNotPass();">审核不通过</button>
							</c:if>
...
$(function(){
	...
	var obj = $("input[type='radio']:checked").val();
   	 $.ajax({
            url:'${dynamicDomain}/newsnotify/check?objectId=${objectId}&check=1&release='+obj,
            type : 'post',
            dataType : 'json',
	...
	<script type="text/javascript">
		function checkNotPass(){
			var obj = $("input[type='radio']:checked").val();
			var url='${dynamicDomain}/newsnotify/check?ajax=1&objectId=${objectId}&check=2&release='+obj;
			$.colorbox({
				opacity : 0.2,
				href : url,
				fixed : true,
	...
	<script type="text/javascript">
		function checkPass(){
	    	...
	    	var myDate= new Date(Date.parse(endDate.replace(/-/g, "/"))); 
		...
		function toList(){
			window.location.href='${dynamicDomain}/newsnotify/verify';
		}
		function comeBack(){
			window.location.href = '${dynamicDomain}/newsnotify/verify';
		}
