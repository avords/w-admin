					...
					<div class="row" id="content" >
	                            <div class="col-sm-12 col-md-12">
	                                <div class="form-group">
	                                    ...
	                                    <div class="col-sm-10">
	                                        <textarea style="width:330px;height: 100px;" name="content" dis></textarea>
	                                    </div>
	                                </div>
	                            </div>
	                </div>
						...
						<div class="row">
                            ...
                            <div class="col-sm-6 col-md-6">
                                <div class="form-group">
                                     ...
                                     <div class="col-sm-8">
                                        <input type="text" class="form-control" name="priority" id="priority" disabled="disabled" min="0">
                                    </div>
                                </div>
                            </div>
                        </div>
...
/* $(function(){
    ...
    function checkPass(){
    	...
    	if(confirm("确定审核通过？")){
    		$.ajax({
    			url: "${dynamicDomain}/advert/getAdvertStatus?objectId=${objectId}",
    			type : 'post',
    			dataType : 'json',
    			success :function (data) {
    				
    			  if(data.result == 3){
    				  window.location.href = '${dynamicDomain}/advert/check?objectId=${objectId}&check=1&release='+obj; 
    			  }
    			  else{
    				  alert("广告非待审核状态，不能进行审核！");
    			  } 
    			}
    		});
	...
	<script type="text/javascript">
		function checkNotPass(){
			var obj = $("input[type='radio']:checked").val();
			var url='${dynamicDomain}/advert/check?ajax=1&objectId=${objectId}&check=2&release='+obj;
			$.colorbox({
				opacity : 0.2,
				href : url,
				fixed : true,
