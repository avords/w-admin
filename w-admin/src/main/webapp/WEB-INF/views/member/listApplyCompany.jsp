...
<div>
	...
	<div>
		<jdf:table items="items" var="currentRowObject" retrieveRowsCallback="limit" filterRowsCallback="limit" sortRowsCallback="limit" action="apply">
			...
			<jdf:row>
				<jdf:column alias="common.lable.operate" title="<input type='checkbox' id='checkall' >" sortable="false" viewsAllowed="html" style="text-align:center"  headerStyle="width: 1%">
				...
				<jdf:column property="applyStatus" title="状态" headerStyle="width:8%;">
					<jdf:columnValue dictionaryId="1308" value="${currentRowObject.applyStatus}" />
				</jdf:column>
				<jdf:column property="3" title="跟进次数" headerStyle="width:5%;" viewsDenied="html">
					${currentRowObject.followSum}
				</jdf:column>
				<jdf:column property="followSum" title="跟进次数" headerStyle="width:5%;" viewsAllowed="html">
				<a href="${dynamicDomain}/companyFollow/create?ajax=1&id=${currentRowObject.objectId}&apply=1" class="colorbox-big">
				<font size="3px;">${currentRowObject.followSum}</font>
				</a></jdf:column>
				<jdf:column property="managerName" title="客户经理" style="width:8%" />
				<jdf:column property="1" title="省" headerStyle="width:5%;">
					${currentRowObject.areaInfo.province}
				</jdf:column>
				<jdf:column property="2" title="市" headerStyle="width:5%;">
					${currentRowObject.areaInfo.city}
				</jdf:column>
