...
<body>
	<div>
		...
		<jdf:form bean="request" scope="request">
			<form action="${dynamicDomain}/company/multiCompanyTemplate?ajax=1" method="post"
				...
				<div class="box-footer">
					<a href="javascript:setCompanies();" class="btn btn-primary pull-left">
						 确认
					</a>
	...
	function setCompanies(){
		...
		for(var i in companies){
			...
			companyDiv.html(companyDiv.html()+'<div class="col-sm-12 col-md-12" id="${inputName}'+count+'"><div class="form-group">'+
					'<div class="col-sm-6"><input type="hidden" class="search-form-control" name="productCompanyPriceForm.${inputName}['+count+'].objectId" value="'+company[0]+'"/>'+
					company[1]+
