	...
	<div>
		<div class="callout callout-info">
			...
			<jdf:form bean="request" scope="request">
				<form method="post" action="${dynamicDomain}/companyStaff/uploadStaffs/${company.objectId}?ajax=1" class="form-horizontal import" id="isform" name="isform" enctype="multipart/form-data">
					<input type="hidden" name="companyId" value="${company.objectId }">
					<div class="box-body">
					<div class="row">
					...
					<div class="row">
						<div class="col-sm-6 col-md-6">
							<div class="form-group">
								<label  class="col-sm-4 control-label"> 公司名称：</label>${company.companyName }
							</div>
						</div>
						<div class="col-sm-6 col-md-6">
							<div class="form-group">
								<label  class="col-sm-4 control-label"> 员工导入：</label><u><a href="${dynamicDomain}/companyStaff/exportTemplate/${company.objectId}" target="_blank">模板下载</a></u><br><br>
								<div class="col-sm-6">
