...
<body>
	<div>
		<div class="callout callout-info">
			...
			<h4 class="modal-title">角色权限配置-${role.name}</h4>
		</div>
		<form action="${dynamicDomain}/role/saveRoleMenu"
			method="post" name="RoleMenu" id="RoleMenu" class="form-horizontal"
			onsubmit="prepare();">
                ...
                <div class="row">
                  <div class="col-sm-4 col-md-4">
                    ...
                    <div class="col-sm-4 col-md-4">
                      <div class="form-group">
                        <div class="col-sm-12">
                          <select multiple class="form-control" name="menuIds" id="selected" style="height: 300px;">
