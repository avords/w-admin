...
<body>
	<div>
		<div class="callout callout-info">
			...
			<h4 class="modal-title">角色用户配置-${role.name}</h4>
		</div>
		<form action="${dynamicDomain}/role/saveRoleUser"
				...
				<div class="row">
                  <div class="col-sm-6 col-md-6">
                      <div class="form-group">
                        <label for="platform" class="col-sm-2 control-label" style="text-align: left;">未选择列表</label>
                        <div class="col-sm-6">
                ...
                <div class="row">
                  <div class="col-sm-4 col-md-4">
                      <div class="form-group">
                        ...
                        <jdf:selectCollection items="notHaveUsers" optionValue="objectId" optionText="loginName" />
                      </select>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="col-sm-4 col-md-4">
                      <div class="form-group">
                        <div class="col-sm-12">
                          <select multiple class="form-control" name="userIds" id="selected" style="height: 300px;">
                        <jdf:selectCollection items="haveUsers" optionValue="objectId" optionText="loginName" />
                      </select>
                        </div>
                      </div>
                    </div>
