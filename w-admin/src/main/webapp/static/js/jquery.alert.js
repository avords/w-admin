...
function maskAlert(_bool) {
	...
	if (_bool) {
		if (_mask.length === 1) {
			...
			$('<div id="' + _id + '"></div>').appendTo('body').css('opacity',
					'.2');
		}
	} else {
		_mask.hide();
...
function winAlert(_msg) {
	...
	if (_bool) {
		...
		var _html = '<table class="m-alert" id="'
				+ _id
				+ '"><tr><td style="text-align:center">'
				+ '<div style="width:360px;" class="z-ib"><h4 class="u-tit">提示信息</h4>'
				+ '<h5 class="u-close"><a href="javascript:void(0);" data-pop="test1" class="j-pop-cancel">×</a></h5>'
				+ '<div class="u-cnt">'
				+ _msg
				+ '</div>'
				+ '<h6 class="u-btn"><a href="javascript:void(0);" class="u-sub j-pop-cancel">确定</a></h6>'
				+ '</div></td></tr></table>';
		$(_html).appendTo('body');
...
//弹窗
function winAlertReloadUrl(_msg,url) {
	var _bool = (typeof (_msg) === 'undefined' || _msg == '') ? false : true;
	...
	if (_bool) {
		...
		var _html = '<table class="m-alert" id="'
				...
				+ _msg
				+ '</div>'
				+ '<h6 class="u-btn"><a href="javascript:void(0);" class="u-sub j-pop-reload-url" onclick="window.location.href=\''+url+';\'">确定</a></h6>'
				+ '</div></td></tr></table>';
		$(_html).appendTo('body');
