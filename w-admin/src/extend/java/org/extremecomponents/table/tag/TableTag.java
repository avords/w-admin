...
public class TableTag extends TagSupport implements TryCatchFinally, TableInterceptor {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 276686910574109490L;
    ...
    public int doStartTag() throws JspException {
        try {
            ...
            String localeName = LocaleUtils.getLocale(pageContext.getSession()).toString();
            model = new TableModelImpl(new JspPageContext(pageContext), localeName);
            // make the table
            Table table = new Table(model);
            //pubx edit begin
            table.setLocale(localeName);
            //pubx edit end
